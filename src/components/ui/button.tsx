...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-sm hover:bg-olive-light",
        accent:
          "bg-terracotta text-white shadow-sm hover:bg-terracotta-dark",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-stone-200/80",
        outline:
          "border border-border bg-transparent hover:bg-stone-100 hover:text-foreground",
        ghost:
